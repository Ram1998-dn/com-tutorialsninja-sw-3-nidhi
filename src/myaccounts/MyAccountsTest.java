...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.name("firstname"), "Prashant");

        // 3.4 Enter the Last Name
        sendTextToElement(By.name("lastname"), "Pate;");

        // 3.5 Enter the Email
        sendTextToElement(By.name("email"), "918Prashant@gmail.com");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextToElement(By.name("email"), "917prashant@gmail.com");
